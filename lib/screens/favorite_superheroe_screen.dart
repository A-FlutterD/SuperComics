...
class FavoriteSuperheroesScreen extends StatefulWidget {
  const FavoriteSuperheroesScreen({super.key});

  @override
  State<FavoriteSuperheroesScreen> createState() => _FavoriteRecipesState();
}

class _FavoriteRecipesState extends State<FavoriteSuperheroesScreen> {
